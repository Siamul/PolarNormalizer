...
def visualize_images(args):
    ...
    for imagename in tqdm(os.listdir(args.image_dir)):
        if imagename.endswith(('jpg', 'jpeg', 'bmp', 'png', 'gif')):
            ...
            image_vis_pil.save(os.path.join(args.vis_dir, imagename))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_net_path', default='./nestedsharedatrousresunet-best.pth')
    parser.add_argument('--circle_net_path', default='./nestedresunetparam-best.pth')
